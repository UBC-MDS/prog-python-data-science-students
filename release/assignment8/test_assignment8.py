...
def test_1a(answer):
    ...
    sha1(str(answer).encode('utf8')).hexdigest() == "3e1a4e12e3ba7129bcd27422d6a77dbb57ec68de", "Your array values are incorrect. Are you slicing properly?"
    return("Success")
...
def test_2c(answer):
    ...
    assert str(answer) == 'datetime64[ns]', "Your object is of the incorrect data type. Are you parsing it as dates?"
...
def test_3(answer,dirty,clean):
    ...
    assert "str.replace" in str_fun, "Make sure you are checking that countries are capitalized."
